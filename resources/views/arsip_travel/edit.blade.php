...
@section('title', 'Edit Arsip Travel - Paiton Operation & Maintenance Indonesia')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" id="form-id" action="{{ route('arsip_travels.update', $arsip_travel->id) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                                            id="title" name="title" value="{{ old('title', $arsip_travel->title) }}" />
                                        @error('title')
