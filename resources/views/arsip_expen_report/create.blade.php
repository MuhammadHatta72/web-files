...
@section('title', 'Tambah Arsip Expen Report - Paiton Operation & Maintenance Indonesia')
@section('sidebar')
...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Tambah Arsip Expen Report</h1>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" id="form-id" action="{{ route('arsip_expen_reports.store') }}"
