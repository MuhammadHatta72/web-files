...
@section('title', 'Tambah Travel Authorization - Paiton Operation & Maintenance Indonesia')
@section('sidebar')
...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Tambah Travel Authorization</h1>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" id="form-id" action="{{ route('travel_authorizations.store') }}">
                                @csrf
                                @method('post')
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('id_ta') is-invalid @enderror"
                                            id="id_ta" name="id_ta" value="{{ "TA" . date('Ymd') . rand(1000, 9999) }}" readonly />
                                        @error('id_ta')
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('request_by') is-invalid @enderror"
                                            id="request_by" name="request_by" value="{{ old('request_by') }}" />
                                        @error('request_by')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('approve_by') is-invalid @enderror"
                                            id="approve_by" name="approve_by" value="{{ old('approve_by') }}" />
                                        @error('approve_by')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-1 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('bn_1') is-invalid @enderror"
                                            id="bn_1" name="bn_1" value="{{ old('bn_1') }}" />
                                        @error('bn_1')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('bn_name_1') is-invalid @enderror"
                                            id="bn_name_1" name="bn_name_1" value="{{ old('bn_name_1') }}" />
                                        @error('bn_name_1')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('departement_1') is-invalid @enderror"
                                            id="departement_1" name="departement_1" value="{{ old('departement_1') }}" />
                                        @error('departement_1')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('charge_1') is-invalid @enderror"
                                            id="charge_1" name="charge_1" value="{{ old('charge_1') }}" />
                                        @error('charge_1')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('passport_1') is-invalid @enderror"
                                            id="passport_1" name="passport_1" value="{{ old('passport_1') }}" />
                                        @error('passport_1')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('bn_price_1') is-invalid @enderror"
                                            id="bn_price_1" name="bn_price_1" value="{{ old('bn_price_1') }}" />
                                        @error('bn_price_1')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-1 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('bn_2') is-invalid @enderror"
                                            id="bn_2" name="bn_2" value="{{ old('bn_2') }}" />
                                        @error('bn_2')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('bn_name_2') is-invalid @enderror"
                                            id="bn_name_2" name="bn_name_2" value="{{ old('bn_name_2') }}" />
                                        @error('bn_name_2')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('departement_2') is-invalid @enderror"
                                            id="departement_2" name="departement_2" value="{{ old('departement_2') }}" />
                                        @error('departement_2')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('charge_2') is-invalid @enderror"
                                            id="charge_2" name="charge_2" value="{{ old('charge_2') }}" />
                                        @error('charge_2')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('passport_2') is-invalid @enderror"
                                            id="passport_2" name="passport_2" value="{{ old('passport_2') }}" />
                                        @error('passport_2')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('bn_price_2') is-invalid @enderror"
                                            id="bn_price_2" name="bn_price_2" value="{{ old('bn_price_2') }}" />
                                        @error('bn_price_2')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-1 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('bn_3') is-invalid @enderror"
                                            id="bn_3" name="bn_3" value="{{ old('bn_3') }}" />
                                        @error('bn_3')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('bn_name_3') is-invalid @enderror"
                                            id="bn_name_3" name="bn_name_3" value="{{ old('bn_name_3') }}" />
                                        @error('bn_name_3')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('departement_3') is-invalid @enderror"
                                            id="departement_3" name="departement_3" value="{{ old('departement_3') }}" />
                                        @error('departement_3')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('charge_3') is-invalid @enderror"
                                            id="charge_3" name="charge_3" value="{{ old('charge_3') }}" />
                                        @error('charge_3')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('passport_3') is-invalid @enderror"
                                            id="passport_3" name="passport_3" value="{{ old('passport_3') }}" />
                                        @error('passport_3')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('bn_price_3') is-invalid @enderror"
                                            id="bn_price_3" name="bn_price_3" value="{{ old('bn_price_3') }}" />
                                        @error('bn_price_3')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-1 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('bn_4') is-invalid @enderror"
                                            id="bn_4" name="bn_4" value="{{ old('bn_4') }}" />
                                        @error('bn_4')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('bn_name_4') is-invalid @enderror"
                                            id="bn_name_4" name="bn_name_4" value="{{ old('bn_name_4') }}" />
                                        @error('bn_name_4')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('departement_4') is-invalid @enderror"
                                            id="departement_4" name="departement_4" value="{{ old('departement_4') }}" />
                                        @error('departement_4')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('charge_4') is-invalid @enderror"
                                            id="charge_4" name="charge_4" value="{{ old('charge_4') }}" />
                                        @error('charge_4')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('passport_4') is-invalid @enderror"
                                            id="passport_4" name="passport_4" value="{{ old('passport_4') }}" />
                                        @error('passport_4')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('bn_price_4') is-invalid @enderror"
                                            id="bn_price_4" name="bn_price_4" value="{{ old('bn_price_4') }}" />
                                        @error('bn_price_4')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('aircraft_name') is-invalid @enderror"
                                            id="aircraft_name" name="aircraft_name" value="{{ old('aircraft_name') }}" />
                                        @error('aircraft_name')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('total_airfare') is-invalid @enderror"
                                            id="total_airfare" name="total_airfare" value="{{ old('total_airfare') }}" />
                                        @error('total_airfare')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('hotel_name_1') is-invalid @enderror"
                                            id="hotel_name_1" name="hotel_name_1" value="{{ old('hotel_name_1') }}" />
                                        @error('hotel_name_1')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('city_1') is-invalid @enderror"
                                            id="city_1" name="city_1" value="{{ old('city_1') }}" />
                                        @error('city_1')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="date" class="form-control @error('checkin_date_1') is-invalid @enderror"
                                            id="checkin_date_1" name="checkin_date_1" value="{{ old('checkin_date_1') }}" />
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="date" class="form-control @error('checkout_date_1') is-invalid @enderror"
                                            id="checkout_date_1" name="checkout_date_1" value="{{ old('checkout_date_1') }}" />
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('hotel_price_1') is-invalid @enderror"
                                            id="hotel_price_1" name="hotel_price_1" value="{{ old('hotel_price_1') }}" />
                                        @error('hotel_price_1')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('hotel_name_2') is-invalid @enderror"
                                            id="hotel_name_2" name="hotel_name_2" value="{{ old('hotel_name_2') }}" />
                                        @error('hotel_name_2')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('city_2') is-invalid @enderror"
                                            id="city_2" name="city_2" value="{{ old('city_2') }}" />
                                        @error('city_2')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="date" class="form-control @error('checkin_date_2') is-invalid @enderror"
                                            id="checkin_date_2" name="checkin_date_2" value="{{ old('checkin_date_2') }}" />
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="date" class="form-control @error('checkout_date_2') is-invalid @enderror"
                                            id="checkout_date_2" name="checkout_date_2" value="{{ old('checkout_date_2') }}" />
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('hotel_price_2') is-invalid @enderror"
                                            id="hotel_price_2" name="hotel_price_2" value="{{ old('hotel_price_2') }}" />
                                        @error('hotel_price_2')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
